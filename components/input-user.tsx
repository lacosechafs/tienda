...
export const InputUser = ({
    ...
    const [data, setData] = useState<string | number | null>(user)
    const [lastData, setLastData] = useState<string | number | null>(user)
        ...
        <div className="lg:mb-2">
            ...
            <div className={`flex justify-between ${border} border-[#ffffff50]`}>
                ...
                <div className="w-1/6 text-center content-center me-2">
                    <button
                        className={`h-[36px] p-2 duration-500 ease-in-out transition-[opacity,color] ${isVisible
                    ...
                    >
                        ...
                        >
                            {iconShow === "save"
                                ? <path className={`duration-500 ease-in-out ${iconAnimate
                                    ? "opacity-0 pointer-events-none"
                                    : "opacity-100 pointer-events-auto"}`}
                                ...
                                : iconShow === "cancel"
                                    ...
                                    : iconShow === "alert"
                                    && <path className={`animate-pulse duration-500 ease-in-out ${iconAnimate
                                        ? "opacity-0 pointer-events-none"
                                        : "opacity-100 pointer-events-auto"}`}
