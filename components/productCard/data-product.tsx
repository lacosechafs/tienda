...
export const DataProduct = ({
    ...
    return (
        <div className="flex flex-col flex-1 px-2 pt-0 md:pt-2 justify-between">
            <div className="flex w-full min-h-14">
                <div className='flex w-full items-center justify-between'>
                    <h2 className="font-bold text-[#fea70e]">{name}</h2>
                                    ...
                                    return (
                                        ...
                                        >
                                            <button
                                                ...
                                                className={`border relative rounded-lg min-w-15 px-2 py-1 me-2 duration-500 ease-in-out ${bgClass} ${!haveStock ? "opacity-50" : "opacity-100"}`}
                                                disabled={!haveStock}
                                            >
                                                {m.size}{m.unit}
                                            </button>
